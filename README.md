...
- **Hallucination Scorer** — Computes a weighted hallucination likelihood score from three RAG evaluation metrics: context accuracy, faithfulness, and answer relevance.
...
- All weights in `calculate_hallucination_score` should sum to `1.0` for the score to remain within a consistent interpretable range.
